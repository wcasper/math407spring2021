...
e) If $$G$$ is a group whose order is divisible by an integer $$n$$, then $$G$$ must have a subgroup of order $$n$$
...
c) Give an example of a group $$G$$ with a subgroup $$H$$ which is not normal.
...
Suppose that $$H$$ and $$K$$ are subgroups of a group $$G$$ and that $$H$$ is normal.  Prove that the set
